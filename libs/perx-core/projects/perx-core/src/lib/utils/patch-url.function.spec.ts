...
describe('patchUrl', () => {
  it('should patch url properly', () => {
    [
      { input: 'http://perx-cdn-staging.s3.amazonaws.com/bla', output: 'https://cdn.getperx.io/bla' },
      { input: 'http://perx-cdn.s3.amazonaws.com/bla', output: 'https://cdn.perxtech.net/bla' },
      { input: 'https://perx-cdn-staging.s3.amazonaws.com/bla', output: 'https://cdn.getperx.io/bla' },
