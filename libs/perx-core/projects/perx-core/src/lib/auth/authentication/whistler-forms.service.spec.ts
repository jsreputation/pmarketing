...
describe('WhistlerFormsService', () => {
    ...
    it('should get SignUpForm', fakeAsync(inject([HttpClient, WhistlerFormsService], (http: HttpClient, formService: WhistlerFormsService) => {
    ...
    it('should create form ',  fakeAsync(inject([HttpClient, WhistlerFormsService], (http: HttpClient, formService: WhistlerFormsService) => {
