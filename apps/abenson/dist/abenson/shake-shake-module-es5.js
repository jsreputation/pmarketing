...
var ShakeRoutingModule = /** @class */ (function () {
    function ShakeRoutingModule() {
    }
...
var gameServiceStub = {
    get: function (id) { return Object(rxjs__WEBPACK_IMPORTED_MODULE_7__["of"])(_mock_games_mock__WEBPACK_IMPORTED_MODULE_8__["games"][id]); },
    getGamesFromCampaign: function (id) { return Object(rxjs__WEBPACK_IMPORTED_MODULE_7__["of"])(_mock_games_mock__WEBPACK_IMPORTED_MODULE_8__["games"].filter(function (game) { return game.campaignId === id; })); }
};
var ShakeModule = /** @class */ (function () {
...
var ShakeComponent = /** @class */ (function () {
    function ShakeComponent(router, notificationService, gameService, route) {
        this.router = router;
    ...
    ShakeComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.game$ = this.route.paramMap
            ...
            return _this.gameService.getGamesFromCampaign(idN);
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (games) { return games.filter(function (game) { return game.type === _perx_core__WEBPACK_IMPORTED_MODULE_3__["GameType"].shakeTheTree; })[0]; }));
        this.actionOnGameStatus();
    };
    ShakeComponent.prototype.actionOnGameStatus = function () {
        var _this = this;
        this.game$.subscribe(function (game) {
    ...
    ShakeComponent.prototype.gameCompleted = function () {
        var _this = this;
        setTimeout(function () {
            _this.router.navigate(['/wallet']);
            _this.notificationService.addPopup({
                title: 'Congratulations!',
                text: _this.congratsDetailText,
...
//# sourceMappingURL=shake-shake-module-es5.js.map