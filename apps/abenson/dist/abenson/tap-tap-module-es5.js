...
var TapRoutingModule = /** @class */ (function () {
    function TapRoutingModule() {
    }
...
var TapComponent = /** @class */ (function () {
    function TapComponent(router, notificationService, gameService, route) {
        this.router = router;
    ...
    TapComponent.prototype.ngOnInit = function () {
        ...
        }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (games) { return games.filter(function (game) { return game.type === _perx_core__WEBPACK_IMPORTED_MODULE_3__["GameType"].pinata; })[0]; }));
        this.actionOnGameStatus();
    };
    TapComponent.prototype.actionOnGameStatus = function () {
        var _this = this;
    ...
    TapComponent.prototype.gameCompleted = function () {
        var _this = this;
        setTimeout(function () {
            _this.router.navigate(['/wallet']);
...
//# sourceMappingURL=tap-tap-module-es5.js.map