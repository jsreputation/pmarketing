...
const surveyServiceStub = {
    // @ts-ignore
    getSurveyFromCampaign: (id) => Object(rxjs__WEBPACK_IMPORTED_MODULE_7__["of"])(_mock_survey_mock__WEBPACK_IMPORTED_MODULE_8__["survey"])
};
...
let SurveyComponent = class SurveyComponent {
    constructor(notificationService, router, route, surveyService) {
