...
const routes: Routes = [
  {
    ...
    children: [
      ...
      },
      {
        path: 'rewards',
        loadChildren: () =>
          import('../rewards/rewards.module').then((mod) => mod.RewardsModule),
        canActivate: [ProtectedGuard],
      },
      {
        path: 'wallet',
        loadChildren: () =>
          import('../wallet/wallet.module').then((mod) => mod.WalletModule),
        canActivate: [ProtectedGuard],
      },
      {
        path: 'history',
      ...
      },
      {
        ...
        loadChildren: () =>
          import('../campaign-landing/campaign-landing.module').then(
            (mod) => mod.CampaignLandingModule
          ),
        canActivate: [ProtectedGuard],
      },
      {
      ...
      },
      {
        path: 'stamp/:id',
        loadChildren: () =>
          import('../campaign-stamps/campaign-stamps.module').then(
            (mod) => mod.CampaignStampsModule
          ),
        canActivate: [ProtectedGuard],
      },
      {
        path: 'stamp-card/:id',
        loadChildren: () =>
          import('../stamp/stamp.module').then((mod) => mod.StampModule),
        canActivate: [ProtectedGuard],
      },
      {
      ...
      },
      {
        path: 'pi',
        loadChildren: () =>
          import('../pi/pi.module').then((mod) => mod.PiModule),
        canActivate: [ProtectedGuard],
      },
      {
        path: 'qr',
        loadChildren: () =>
          import('../qr/qr.module').then((mod) => mod.QRModule),
        canActivate: [ProtectedGuard],
      },
      {
        path: 'account',
      ...
      },
      {
        path: 'lucky-draw',
        loadChildren: () =>
          import('../lucky-draw-details/lucky-draw-details.module').then(
            (mod) => mod.LuckyDrawDetailsModule
          ),
        canActivate: [ProtectedGuard],
      },
      {
      ...
      },
      {
        ...
        loadChildren: () =>
          import('../rewards-detail/rewards-detail.module').then(
            (mod) => mod.RewardsDetailModule
          ),
        canActivate: [ProtectedGuard],
      },
      {
        ...
        loadChildren: () =>
          import('../reward-voucher-detail/reward-voucher-detail.module').then(
            (mod) => mod.RewardVoucherDetailModule
          ),
        canActivate: [ProtectedGuard],
      },
      {
        path: 'booking/:id',
        loadChildren: () =>
          import('../rewards-booking/rewards-booking.module').then(
            (mod) => mod.RewardsBookingModule
          ),
      },
      {
        path: 'profile',
      ...
      },
      {
        ...
        loadChildren: () =>
          import('../transaction-history/transaction-history.module').then(
            (mod) => mod.TransactionHistoryModule
          ),
      },
      {
      ...
      },
      {
        ...
        loadChildren: () =>
          import('../edit-profile-field/edit-profile-field.module').then(
            (mod) => mod.EditProfileFieldModule
          ),
      },
      {
        path: 'catalogs',
      ...
      },
      {
        path: 'rebates',
        loadChildren: () =>
          import('../rebates/rebates.module').then((mod) => mod.RebatesModule),
      },
      {
        path: 'locations',
        loadChildren: () =>
      ...
      },
      {
        path: 'nearme',
        loadChildren: () =>
          import('../nearme/nearme.module').then((mod) => mod.NearmeModule),
        canActivate: [ProtectedGuard],
      },
      {
        path: 'find-out-more',
        loadChildren: () =>
          import('../find-more/find-more.module').then(
            (mod) => mod.FindMoreModule
          ),
        canActivate: [ProtectedGuard],
      },
      {
