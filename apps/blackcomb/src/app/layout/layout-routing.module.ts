...
import { HomeComponent, WalletComponent, HistoryComponent, RedeemComponent, VoucherDetailComponent, LoadingComponent, ContentComponent, RewardDetailsComponent } from '@perx/blackcomb-pages';
