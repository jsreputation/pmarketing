...
Given(/^4_I am on the general settings page.$/, async () => {
  ...
  await browser.wait(ec.elementToBeClickable(ElementApp.inputArray().get(0)), 5000);
  // entering correct account id
  await ElementApp.inputArray().get(0).sendKeys(LoginAppPage.getAccountId());
  ...
  await ElementApp.inputArray().get(0).sendKeys(protractor.Key.ENTER);
