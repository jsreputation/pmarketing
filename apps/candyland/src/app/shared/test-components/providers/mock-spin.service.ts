...
export class MockSpinService implements Partial<SpinService> {
  ...
  public getSpin(): Observable<Partial<ISpinEntityForm>> {
    return of(this.getISpinFormData());
  }

  public createSpin(): Observable<IJsonApiItemPayload<IWSpinGameEngagementAttributes>> {
    return of(null);
  }

  public updateSpin(): Observable<IJsonApiItemPayload<IWSpinGameEngagementAttributes>> {
    return of(null);
  }
}
