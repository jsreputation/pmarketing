...
export class CampaignsHttpsService {
  ...
  public updateCampaign(id: string, data: IJsonApiPatchItem<ICampaign>): Observable<IJsonApiPayload<ICampaignAttributes>> {
    return this.http.patch<IJsonApiPayload<ICampaignAttributes>>(ApiConfig.campaignsPath + '/' + id, data);
  }

  public createCampaign(data: IJsonApiPostItem<ICampaignAttributes>): Observable<IJsonApiPayload<ICampaignAttributes>> {
