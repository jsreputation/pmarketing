...
export interface IEngagementCommon {
  id: string;
  type: string;
  urn?: string;
  created_at: string;
...
export interface IEngagementSpinType extends IEngagementCommon {
  game_type: string;
  title: string;
  description: string;
  image_url: string;
...
export interface IEngagementSnakeType extends IEngagementCommon {
  game_type: string;
  title: string;
  description: string;
  image_url: string;
...
export interface IEngagementScratchType extends IEngagementCommon {
  game_type: string;
  title: string;
  description: string;
  image_url: string;
...
export interface IEngagementShakeType extends IEngagementCommon {
  game_type: string;
  title: string;
  description: string;
  image_url: string;
...
export interface IEngagementTapType extends IEngagementCommon {
  game_type: string;
  title: string;
  description: string;
  image_url: string;
...
export interface IEngagementStamps extends IEngagementCommon {
  title: string;
  description: string;
  image_url: string;
  slots: number[];
...
export interface IEngagementSurvey extends IEngagementCommon {
  title: string;
  description: string;
  image_url: string;
  title_display: string;
...
export interface IEngagementInstantReward extends IEngagementCommon {
  title: string;
  description: string;
  image_url: string;
  title_display: string;
