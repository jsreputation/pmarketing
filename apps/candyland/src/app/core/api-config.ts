...
export class ApiConfig {
  ...
  public static voucherBatchPath: string = `${ApiConfig.basePath}/voucher-services/batch`;
  // public static vouchersPath: string = `${ApiConfig.basePath}/vouchers/batches`;
  public static vouchersEntitiesPath: string = `${ApiConfig.basePath}/voucher-services/entities`;
  public static vouchersAssignedPath: string = `${ApiConfig.basePath}/voucher-services/vouchers`;
