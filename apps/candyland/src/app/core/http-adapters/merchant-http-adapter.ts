...
export class MerchantHttpAdapter {
  public static transformToMerchantForm(data: IWMerchant): IMerchantForm {
    return {
      name: data.name,
      type: data.type,
      id: data.id,
  ...
  public static transformFromMerchantForm(data: IMerchantForm): IJsonApiItem<IWMerchant> {
    return {
      type: 'orgs',
      attributes: {
        name: data.name,
  ...
  public static transformFromMerchantBranchForm(data: MerchantBranch, merchantId?: string): IJsonApiItem<IWMerchantBranchApi> {
    return {
      type: 'branches',
      attributes: {
        name: data.name,
